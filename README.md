...
| 🚀 **Projects** | Full-stack & AI-powered real-world projects | [View →](./projects/) |
...
<details>
<summary><b>📦 Click to expand JS topics</b></summary>

<br/>

- ✅ Core JS (var/let/const, hoisting, closures, scope)
...
- ✅ Mini Projects (Calculator, Todo App, Weather App, etc.)
...
```
Mon - Sun  |  🧩 LeetCode Problem of the Day
Mon / Wed  |  ☕ DSA in Java (new topic or implementation)
Tue / Thu  |  🌐 JavaScript concept or mini-project
Fri        |  🔧 LLD — Design Pattern / System
Weekend    |  🚀 Project work / revision / blog
```

> _Consistency > Intensity. Show up every day._
...
**⭐ Star the repos if you find them helpful! Every star motivates me to keep going. 🚀**
